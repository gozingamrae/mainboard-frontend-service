...
function Navbar() {
  ...
  const hoverHandler = () => {
    // 여기부터
    document.querySelectorAll("#row>#menu").style.backgroundColor = "#fff";
    document.querySelector("#row>#menu").style.backgroundColor = "#fff";
  };
  ...
  const hiddenNavbar = () => {
    const hidden = (
      ...
      // </div>
      <div className={hiddenStyle.layout}>
        <div className={hiddenStyle.hiddenLayout}>
