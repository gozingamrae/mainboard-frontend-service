...
import style from "../css/delivery-address-insert.module.css";
...
function DeliveryAddressInsert() {
  // 유효성 검사 추가 예정
  ...
  return (
    <div className={style.layout}>
      ...
      <button onClick={sendAddressData}>추가하기</button>
    </div>
  );
}

export default DeliveryAddressInsert;
